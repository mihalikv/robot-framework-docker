...
RUN add-apt-repository ppa:deadsnakes/ppa && apt-get update && apt-get install -y python3.7 && update-alternatives --install /usr/bin/python3 python3 /usr/bin/python3.7 1
